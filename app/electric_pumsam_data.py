...
ELECTRIC_RULES = [
    ...
    "7. 전선관·박스·덕트·트레이·몰딩·콘센트·스위치·등기구·분전반·차단기 인부는 내선전공입니다.",
    "8. 전력·제어·VVF·VVR 케이블 인부는 저압케이블전공입니다.",
    "9. 배선용단자함·가로등기초·수평도체는 내선전공과 보통인부를 함께 넣습니다.",
    "10. 배관용 홈파기는 보통인부만 넣습니다.",
    "11. 단가대비표의 명칭+규격이 이 표와 글자 그대로 같아야 붙습니다. 비슷한 지중/노출 이름은 끌어오지 않습니다.",
    "12. 표에 없는 품목은 전기 내선전공 1명만 넣습니다.",
]
...
def electric_pumsam_rows() -> list[PumsamRow]:
    ...
    for row in (*_conduit_block(), *_indoor_block(), *_wire_cable_block(), *_gear_light_block()):
